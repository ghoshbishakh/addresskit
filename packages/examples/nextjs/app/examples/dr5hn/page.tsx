    ...
    <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Uses the dr5hn Countries-States-Cities database. Provides comprehensive state and province lists with fallback country metadata.
        </p>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Select country and state from dr5hn dataset.</CardDescription>
                </div>
                <Badge variant="secondary">dr5hn Dataset</Badge>
              </div>
            </CardHeader>
            <CardContent>
              <Address
